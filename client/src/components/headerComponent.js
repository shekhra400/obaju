...
return (
    <header class="header mb-5">
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="index.html" class="navbar-brand home"><img src={logo} alt="Obaju logo" class="d-none d-md-inline-block" /><img src="img/logo-small.png" alt="Obaju logo" class="d-inline-block d-md-none" /><span class="sr-only">Obaju - go to homepage</span></a>
